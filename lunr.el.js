      ...
      var Among = lunr.stemmerSupport.Among,
        ...
        st = new function() {
          ...
          function r_has_min_length() {
            // (, line 110
            if (!(base.current && base.current.length >= 3)) {
              return false;
            }
            return true;
          };
